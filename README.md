...
| **WebApi management**                  | Webapi endpoints to list and manage tasks execution in EverTask remotely                                                                                                                          |
| **Recurring Tasks**                    | Recurring tasks using cron expressions or fluent builder (*cron already implemented in the recurring-cron branch*).                                                                               |
