...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
    ...
    public async Task Should_persist_Task()
    {
        ...
        pending[0].RecurringTask.ShouldBe("{\"RunNow\":false,\"InitialDelay\":null,\"SpecificRunTime\":null,\"CronInterval\":{\"CronExpression\":\"5 * * * *\"},\"SecondInterval\":null,\"MinuteInterval\":null,\"HourInterval\":null,\"DayInterval\":null,\"MonthInterval\":null,\"MaxRuns\":null}");
