...
public class ExecutionLogsEndpointTests : MonitoringTestBase
{
    ...
    public async Task Should_return_logs_when_task_exists()
    {
        ...
        // Act
        var response = await Client.GetAsync($"/evertask/api/tasks/{taskId}/execution-logs");
    ...
    public async Task Should_return_200_with_empty_when_task_not_found()
    {
        ...
        // Act
        var response = await Client.GetAsync($"/evertask/api/tasks/{nonExistentId}/execution-logs");
    ...
    public async Task Should_paginate_when_skip_take_provided()
    {
        ...
        var response = await Client.GetAsync($"/evertask/api/tasks/{taskId}/execution-logs?skip=100&take=100");
    ...
    public async Task Should_filter_by_level_when_level_provided()
    {
        ...
        var response = await Client.GetAsync($"/evertask/api/tasks/{taskId}/execution-logs?level=Error");
    ...
    public async Task Should_filter_correctly_for_each_level(string level)
    {
        ...
        var response = await Client.GetAsync($"/evertask/api/tasks/{taskId}/execution-logs?level={level}");
    ...
    public async Task Should_handle_pagination_edge_cases()
    {
        ...
        var response1 = await Client.GetAsync($"/evertask/api/tasks/{taskId}/execution-logs");
        ...
        var response2 = await Client.GetAsync($"/evertask/api/tasks/{taskId}/execution-logs?skip=100&take=50");
