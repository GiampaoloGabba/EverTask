...
public class StatisticsControllerTests : MonitoringTestBase
{
    ...
    {
        // Act
        var response = await Client.GetAsync($"/evertask/api/statistics/success-rate-trend?period={period}");
    ...
    {
        // Act
        var response = await Client.GetAsync($"/evertask/api/statistics/task-types?range={range}");
    ...
    {
        // Act
        var response = await Client.GetAsync($"/evertask/api/statistics/execution-times?range={range}");
